...
<body class="d-flex flex-column min-vh-100">
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm">
        <div class="container">
            ...
            <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarMenu" aria-controls="navbarMenu" aria-expanded="false" aria-label="Apri menu">
                    ...
                    <div class="ms-auto mt-3 mt-lg-0">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-lg-end">
                                <li>
                                    <a class="dropdown-item text-danger" href="logout.php">Esci</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <?php require $templateParams['content_page']; ?>

    <footer class="footer bg-primary text-white text-center py-3">
        <div class="container">
            <p class="mb-0">© <?php echo date('Y'); ?> StudyGroups</p>
        </div>
    </footer>
